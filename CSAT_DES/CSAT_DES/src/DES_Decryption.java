...
public class DES_Decryption {
    ...
    private String ciphertext, key, decryptedtext;
    ...
    public DES_Decryption(String plain, String K) {
    ...
    public String Decrypt() {
    	...
    	String binaryPlaintext=string2binary(ciphertext);
    	...
    	for(int n=0; n<numBlocks; n++) {
            ...
            decryptedtext+=inverseIP;
    	}
    	
    	//Chuyển ciphertext về chuỗi dạng ascii
    	decryptedtext=binary2string(decryptedtext);
